                    ...
                    <table class="table table-striped table-borderless">
                        ...
                        <tbody class="table-content" id="myTable">
                            <tr>
                                ...
                                <td class="case-law-btnn">
                                    <p class="case-law-p mb-0">(1) This Act may be called the Essential Commodities Act,
                                        1955.</p>
                                    <a class="moreless-button mx-auto" href="#">
                            ...
                            <tr>
                                ...
                                <!-- <td>Lorem ipsum dolor sit amet, consectetur</td> -->
                                <td class="case-law-btnn">
                                    <p class="case-law-p mb-0"> In these rules, unless there is anything repugnant in
                                        the subject
                                        or context,-
                            ...
                            <tr>
                                ...
                                <!-- <td>Lorem ipsum dolor sit amet, consectetur</td> -->
                                <td class="case-law-btnn">
                                    <p class="case-law-p mb-0">Save as otherwise provided in this Act, the provisions of
                                        the Code
                                        (including the
                                        provisions as to bail and bonds) shall apply to the proceedings before a Special
                                        Court and for the purposes of the said provisions, the Special Court shall be
                                        deemed
                                    ...
                                    <a class="moreless-button d-flex justify-content-center" href="#"><i
                            ...
                            <tr>
                                ...
                                <!-- <td>Lorem ipsum dolor sit amet, consectetur</td> -->
                                <td class="case-law-btnn">
                                    <p class="case-law-p mb-0">An order made under section 3 may confer powers and
                                        impose duties
                                        upon the Central
                                        Government or the State Government or Officers and authorities of the Central
                                        Government or State Government and may contain directions to any State
                                        Government or
                            ...
                            <tr>
                                ...
                                <!-- <td>Lorem ipsum dolor sit amet, consectetur</td> -->
                                <td class="case-law-btnn">
                                    <p class="case-law-p mb-0">(1) (a) In every establishment all the inside walls of
                                        the rooms
                                        ...
                                        washed at intervals of not more than twelve months dating from the time when
                                        they
                                        ...
                                        lime-washed or colour-washed at intervals of not more than twelve months dating
                                        from
                                        the time when they were
                                        last lime- washed or colour-washed or shall be painted or varnished at intervals
                                        of
                                        not more than seven years dating
                                        from the time when they were last painted or varnished and shall be maintained
                                        in a
                                        clean state.
                                        ...
                                        in the Opinion of the Commissioner of Labour, unnecessary to satisfy the
                                        requiremet5
                                        of section 20 in regard to
                                        cleanliness.
                                        (2) Rubbish, filth or debris shall not be allowed to accumulate or to remain on
                                        any
                                        ...
                                        masonry or other
                                        impermeable material and shall be regularly flushed at least twice daily and
                                        where
                                        ...
                                        condition. The floors shall be swept or otherwise cleaned at least once daily,
                                        and
                                        ...
                                        employer shall make suitable arrangements for the regular cleaning and
                                        conserving of
                            ...
                            <tr>
                                ...
                                <!-- <td>Lorem ipsum dolor sit amet, consectetur</td> -->
                                <td class="case-law-btnn">
                                    <p class="case-law-p mb-0">In every room of an establishment ventilating opening
                                        shall be
                                        provided in the proportion of 0.5 square metre
                                        for each worker employed in such room and the opening shall be such as to admit
                                        of a
                                        continued supply of fresh air:
                                        Provided that subject to the control of the Commissioner of Labour, the
                                        Inspector
                                        may, for reasons to be
                                        recorded in writing, relax the conditions of this rule where, in his opinion,
                                        this
                            ...
                            <tr>
                                ...
                                <!-- <td>Lorem ipsum dolor sit amet, consectetur</td> -->
                                <td class="case-law-btnn">
                                    <p class="case-law-p mb-0">Where a person is prosecuted for contravening any order
                                        made under
                                        section 3 which
                                        prohibits him from doing any act or being in possession of a thing without
                                        lawful
                                        authority or without a permit, license or other document, the burden of
                                        providing
                            ...
                            <tr>
                                ...
                                <!-- <td>Lorem ipsum dolor sit amet, consectetur</td> -->
                                <td class="case-law-btnn">
                                    <p class="case-law-p mb-0">No suit, prosecution or other legal proceeding shall lie
                                        against
                                        any person for
                                        anything which is in good faith done or intended to be done in pursuance of any
                                        order made under section 3.</p>
                                    <!-- <a class="moreless-button d-flex justify-content-center" href="#"><i class="fa fa-angle-double-down"></i></a>
                                    </td> -->
                                <td> <button type="button" class="btn btn-sm button-readmore-white mx-2"
                                        onclick="window.location.href='act-definition.php'">Read
                                        more</button>
