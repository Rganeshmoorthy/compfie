...
<body>
    ...
    <div class="main-content">
        ...
        <div class="row px-3 px-md-5 ">
            <a href="schemes.php"><button type="button" class="bg-bt text-white pr-2"><i
                        class="fa fa-arrow-left text-white px-1 nav-prev" aria-hidden="true"></i>Goto Schemes</button></a>
