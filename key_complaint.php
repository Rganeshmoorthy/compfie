                            ...
                            <div class="d-flex border alpha-border">
                                ...
                                <div class="d-flex">
                                    ...
                                    <ol type="1" class="p-1 px-4 ol-content">
                                        <li class="mt-2"><a class="ol-content" href="redirect-profesional.php.php"> Andaman &
                        ...
                        <div class="col-12 mt-3 w-100" id="b">
                            <div class="d-flex border">
                                ...
                                <div class="w-100">
                                    ...
                                    <ol type="1" class="p-1 px-4 ol-content">
                                        <li class="mt-2"><a class="ol-content" href="redirect-profesional.php.php"> Boilers Act,
                                                1923
                                            </a></li>
                                        <li class="mt-2"><a class="ol-content" href="redirect-profesional.php"> Coir Industry
                                                Act,
                                                1953</a></li>
                                    </ol>
                        ...
                        <div class="col-12 mt-3 w-100" id="c">
                            <div class="d-flex border">
                                ...
                                <div class="w-100">
                                    ...
                                    <ol type="1" class="p-1 px-4 ol-content">
                                        <li class="mt-2"><a class="ol-content" href="redirect-profesional.php"> Central
                                                Industrial
                                                Security Force Act, 1968


                                            </a></li>
                                        <li class="mt-2"><a class="ol-content" href="redirect-profesional.php">Clinical
                        ...
                        <div class="col-12 mt-3 w-100" id="d">
                            <div class="d-flex border">
                                ...
                                <div class="w-100">
                                    ...
                                    <ol type="1" class="p-1 px-4 ol-content">
                                        <li class="mt-2"><a class="ol-content" href="redirect-profesional.php">

                                                Dangerous Machines (Regulation) Act, 1983
                                            </a></li>
                                        <li class="mt-2"><a class="ol-content" href="redirect-profesional.php">Drugs and
                                                Cosmetic
                                                Act , 1940</a> </li>
                                    </ol>
                            ...
                            <div class="d-flex border">
                                ...
                                <div class="w-100">
                                    ...
                                    <ol type="1" class="p-1 px-4 ol-content">
                                        ...
                                        <li class="mt-2"><a class="ol-content" href="redirect-profesional.php">Employers'
                                                Liability
                                                Act, 1938</a> </li>
                                        <li class="mt-2"><a class="ol-content" href="redirect-profesional.php"> Environment
                                                (Protection) Act, 1986</a></li>
                                        <li class="mt-2"><a class="ol-content" href="redirect-profesional.php"> Essential
                                                Commodities Act, 1955
                                            </a></li>
                                        <li class="mt-2"><a class="ol-content" href="redirect-profesional.php"> Explosives Act
                                                1884, 1900</a></li>
                        ...
                        <div class="col-12 mt-3 w-100" id="f">
                            <div class="d-flex border">
                                ...
                                <div class="w-100">
                                    ...
                                    <ol type="1" class="p-1 px-4 ol-content">
                                        <li class="mt-2"><a class="ol-content" href="redirect-profesional.php"> Assam Lifts And
                                                Escalators Act, 1990
                                            </a></li>
                                        <li class="mt-2"><a class="ol-content" href="redirect-profesional.php">Assam Lifts And
                        ...
                        <div class="col-12 mt-3 w-100" id="z">
                            <div class="d-flex border">
                                ...
                                <div class="w-100">
                                    ...
                                    <ol type="1" class="p-1 px-4 ol-content">
                                        <li class="mt-2"><a class="ol-content" href="redirect-profesional.php.php"> Assam Lifts And
                                                Escalators Act, 1990
                                            </a></li>
                                        <li class="mt-2"><a class="ol-content" href="redirect-profesional.php.php">Assam Lifts And
                                                Escalators Act, 1990</a> </li>
