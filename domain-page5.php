                        ...
                        <div class="col-12 mt-3 w-100" id="b">
                            <div class="d-flex border">
                                ...
                                <div class="w-100">
                                    ...
                                    <ol type="1" class="p-1 px-4 ol-content">
                                        <li class="mt-2"><a class="ol-content" href="redirect-state-rules.php"> Boilers
                                                Act,
                                                1923
                                            </a></li>
                                        <li class="mt-2"><a class="ol-content" href="redirect-state-rules.php"> Coir
                                                Industry
                                                Act,
                                                1953</a></li>
                                    </ol>
                                    ...
                                    <div class="for-readmore">
                                        <ol type="1" class="p-1 px-4 ol-content">
                                            ...
                                            <li class="mt-2"><a class="ol-content"
                                                    href="redirect-state-rules.php">Employers'
                                                    Liability
                                                    Act, 1938</a> </li>
                                            <li class="mt-2"><a class="ol-content" href="redirect-state-rules.php">
                                                    Environment
                        ...
                        <div class="col-12 mt-3 w-100" id="f">
                            <div class="d-flex border">
                                ...
                                <div class="w-100">
                                    ...
                                    <ol type="1" class="p-1 px-4 ol-content">
                                        <li class="mt-2"><a class="ol-content" href="redirect-state-rules.php"> Assam
                                                Lifts And
                                                Escalators Act, 1990
                                            </a></li>
                                        <li class="mt-2"><a class="ol-content" href="redirect-state-rules.php">Assam
